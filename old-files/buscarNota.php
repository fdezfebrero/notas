...
if(isset($_GET['buscar'])){
    ...
    if ($nome && $id) {
        ...
        $pdoStatement=$pdo->prepare("SELECT  * FROM Notas WHERE $campo like ?");
    ...
    echo '<div class="container text-center"><img class="img-aviso rounded mx-auto d-block" src="./img/smiley-1635450"  alt="..."><h2 class="textcenter">Non introduciches unha nota para gardar</h2></div>';
}
